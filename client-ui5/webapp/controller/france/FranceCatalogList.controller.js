sap.ui.define([
    ...
    return Controller.extend("invoice.app.controller.france.FranceCatalogList", {

        onInit: function () {
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("franceCatalogList").attachPatternMatched(this._onRouteMatched, this);
        ...
        onCreateProduct: function () {
            this.getOwnerComponent().getRouter().navTo("franceCatalogNew");
        },
        ...
        onProductPress: function (oEvent) {
            ...
            this.getOwnerComponent().getRouter().navTo("franceCatalogEdit", {
