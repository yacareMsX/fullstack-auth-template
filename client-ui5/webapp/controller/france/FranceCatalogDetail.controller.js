sap.ui.define([
    ...
    return Controller.extend("invoice.app.controller.france.FranceCatalogDetail", {

        onInit: function () {
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("franceCatalogNew").attachPatternMatched(this._onNewProduct, this);
            oRouter.getRoute("franceCatalogEdit").attachPatternMatched(this._onEditProduct, this);
        ...
        _loadProduct: function (sId) {
            ...
            fetch("/api/catalog/products/" + sId, {
        ...
        onNavBack: function () {
            this.getOwnerComponent().getRouter().navTo("franceCatalogList");
        }
    });
});
