sap.ui.define([
    ...
    return Controller.extend("invoice.app.controller.france.FranceOriginList", {
        ...
        onInit: function () {
            ...
            oRouter.getRoute("franceOriginList").attachPatternMatched(this._onRouteMatched, this);
        },
