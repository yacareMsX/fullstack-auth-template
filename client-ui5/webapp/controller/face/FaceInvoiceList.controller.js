sap.ui.define([
    ...
    return Controller.extend("invoice.app.controller.face.FaceInvoiceList", {
        formatter: formatter,
        ...
        _loadInvoices: function (sStatus) {
            ...
            var sUrl = "/api/face/invoices/facturas?tipo=" + sTipo;
        ...
        onInvoiceSelect: function (oEvent) {
            ...
            this.getOwnerComponent().getRouter().navTo("faceInvoiceDetail", {
                invoiceId: sInvoiceId
            });
        },

        onCreateInvoice: function () {
            this.getOwnerComponent().getRouter().navTo("faceInvoiceNew");
        },
