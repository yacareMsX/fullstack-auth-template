sap.ui.define([
    ...
    return Controller.extend("invoice.app.controller.face.FaceFacturaUBL", {

        onInit: function () {
            var oRouter = this.getOwnerComponent().getRouter();
            // Attach to face route
            oRouter.getRoute("faceUbl21").attachPatternMatched(this._onObjectMatched, this);
